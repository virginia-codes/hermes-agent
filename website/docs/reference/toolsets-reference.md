...
- **Capability-gated** tools (browser, `computer_use`, `code_execution`, Home Assistant, cronjob) appear only when their backend/credential prerequisite is configured.
